...
end_str = "        await _reply(update, context, \"❌ Ошибка при загрузке личного кабинета из API.\")\n        if update.callback_query:"
...
# we actually need to look at what was replaced
end_idx = content.find("async def handle_main_menu", start_idx)
if end_idx == -1:
    print("Could not find end def.")
    sys.exit(1)
...
# Convert \\n back to \n in the replacement string to be literal string \n
