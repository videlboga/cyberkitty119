...
# --- CORE API MODULES (V2) ---
from core_api.api.v1.internal_bot import router as internal_bot_router
app.include_router(core_system_router.router, prefix="/api/v1/system")
app.include_router(internal_bot_router, prefix="/api/v1/internal_bot")
...
from core_api.api.v1 import agent as core_agent_router
