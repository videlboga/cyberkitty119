#!/usr/bin/env python3
"""
Тестовый бот с отключённой SSL верификацией для отладки.
"""
...
logger = logging.getLogger("test_bot_nossl")
...
def main() -> None:
    logger.info("=" * 60)
    logger.info("🤖 ЗАПУСК БОТА БЕЗ SSL ВЕРИФИКАЦИИ")
    logger.info("=" * 60)
    
    # Создаём SSL контекст без верификации (ТОЛЬКО ДЛЯ ОТЛАДКИ!)
