...
# match the old show_personal_cabinet function
pattern = r"async def show_personal_cabinet\(update: Update, context: ContextTypes\.DEFAULT_TYPE\) -> None:.*?await _reply\(update, context, \"❌ Ошибка при загрузке личного кабинета\"\)"
